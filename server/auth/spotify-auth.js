// /** NOT CURRENTLY USED, JUST KEEPING FOR ACCESS TO OLD ROUTES
...
//         // now we have the access token to make requests to the Spotify API
//         var access_token = body.access_token,
//           refresh_token = body.refresh_token

//         // get one request ready for ALBUMS
//         var options = {
...
//         // this is also what happens in the example here (https://github.com/mpj/oauth-bridge-template)
//         res.redirect(
//           '/#' +
//             querystring.stringify({
